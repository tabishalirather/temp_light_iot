...
def on_message(client, userdata, msg):
	...
	try:
		cursor.execute("INSERT INTO light_reads (timestamp, light_value) VALUES (%s, %s)", (timestamp, light))
		db_conn.commit()
		print(f"Successfully inserted light {light} and timestamp {timestamp} into database.")
	except Error as e:
